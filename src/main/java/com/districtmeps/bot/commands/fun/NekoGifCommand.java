 ...
 * NekoGifCommand
 */
public class NekoGifCommand implements ICommand {

    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {

        WebUtils.ins.getJSONObject("https://nekos.life/api/v2/img/ngif").async((json) -> {
    ...
    public String getHelp() {
        return "Sends a neko gif (might be nsfw, but I highly doubt)";
    }
