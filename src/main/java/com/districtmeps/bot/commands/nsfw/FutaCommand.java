 ...
 * FutaCommand
 */
public class FutaCommand implements ICommand {

    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
        if (event.getChannel().isNSFW()) {
            WebUtils.ins.getJSONObject("https://nekos.life/api/v2/img/futanari").async((json) -> {
    ...
    public String getHelp() {
        return "Sends hentai with *futanari*";
    }
